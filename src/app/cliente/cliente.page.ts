...
export class ClientePage {
  cliente: Cliente = { nome: '', email: '', dataCadastro: new Date() };  // Inclui a data atual
  ...
  cadastrarCliente() {
    ...
    this.clienteService.addCliente(this.cliente).then(() => {
      ...
      this.cliente = { nome: '', email: '', dataCadastro: new Date() };  // Limpa o formulário e reinicia a data
    }).catch((error) => {
